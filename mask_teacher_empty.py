        ...
        for p in self.h5_paths:
            with h5py.File(p, "r") as f:
                ...
                for t in range(T):
                    ...
                    if t == 0:
                        self.indices.append(SampleIndex(path=p, t=0))

                    # transition: empty -> active
                    elif prev_count <= threshold and curr_count > threshold:
...
def main(args):
    ...
    if args.resume_ckpt_path is not None:
        ...
        print(f"[resume] loaded from {args.resume_ckpt_path}")
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "--resume_ckpt_path",
        type=str,
        default=None, #"/mnt/ddrive/src/ROBROS_IMITATION_LEARNING/outputs/student_prev_best.pt",
