...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        default="/home/robros-ai/dg/robros_imitation_learning/ckpt/default",
        help="ckpt_dir",
        required=False,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        default="dsr_single_block_sorting",
        help="task_name",
        required=False,
    )
    parser.add_argument(
        "--seed", action="store", type=int, default=0, help="seed", required=False
    )
    parser.add_argument(
        "--num_steps",
        action="store",
